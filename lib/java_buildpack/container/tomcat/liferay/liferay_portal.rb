...
module JavaBuildpack
    module Container
        ...
        class LiferayPortal < JavaBuildpack::Component::VersionedDependencyComponent
                ...
                if service.to_s ==''
                    ...
                    if File.exist? (file)
                        ...
                        with_timing "Creating portal-ext.properties in #{file}" do
                            ...
                            jdbc_url      = "jdbc:mysql://#{host_name}:#{port}/#{db_name}?useSSL=false&useUnicode=true&characterEncoding=UTF-8&useFastDateParsing=false"
                            ...
                            File.open(file, 'w') do  |file|
                                ...
                                file.puts("hibernate.show_sql=true\n")
            ...
            end #end configure_mysql_service
        end #end class
    end #end module Container
end #end module Javabuildpack
